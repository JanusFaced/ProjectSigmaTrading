...
def backTestAnalyst(
	...
	profit_factor = [report['general']['profitFactor'], report['long']['profitFactor'], report['short']['profitFactor']]
	...
	if analystMode == False:
		...
		logger.info(f'profit_factor {profit_factor[0]} (L:{profit_factor[1]}|S:{profit_factor[2]})')
