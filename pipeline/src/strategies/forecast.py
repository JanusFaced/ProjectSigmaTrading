...
import polars as pl
import os
from custom_ta import adaptive_lr_forecast, adaptive_moving, adaptive_adx
...
def main(inputMessage: dict[str, Any]) -> None:
	...
	model = adaptive_lr_forecast(
		diffVector=dataFrame['close'].to_numpy(),
	...
	#superName = str(output_dir) + f'/forecast_{nameExchange}_{symbol}_{type}_{timeFrame}.png'
